...
class ApiConfig {
  ...
  static String get savingsOverviewEndpoint => '$baseUrl/api/budget-goals/savings-overview/';
  static String get financialAdviceEndpoint => '$baseUrl/api/budget-goals/financial-advice/';
